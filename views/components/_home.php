...
<div class="row">
    ...
    <div class="col-md-8">
        <?php
            include './components/_newsFeed.php';
            include './components/_findFriends.php';
            include './components/_requests.php';
            include './components/_profile.php';
            include './components/_album.php';
         ?>
    </div>
