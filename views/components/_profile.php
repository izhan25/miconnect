...
<div id="profile">
    ...
    <div class="row">
        <div class="col-md-12">
            <img src="<?php echo $root ?>include/images/users/<?php echo $_SESSION['user']['image'] ?>" 
                 class="img-fluid img-thumbnail mx-auto d-block user-image" 
                 alt="Profile_Image" 
                 data-toggle="modal" 
            ...
            <div class="table-responsive">
                <table class="table table-bordered user-table">
                    <tbody>
                        ...
                        <tr>
                            <td>Full Name:</td>
                            <td class="text-capitalize font-weight-bold"><?php echo $_SESSION['user']['full_name'] ?></td>
                        </tr>
                        <tr>
                            <td>Email:</td>
    ...
    <div class="row">
        <div class="col-md-12">
            <button class="btn btn-default btn-sm float-right" style="border-radius: 5px;" data-toggle="modal" data-target="#changePassword">Change Password</button>
            
            <button class="btn btn-default btn-sm float-right mr-1" style="border-radius: 5px;" data-toggle="modal" data-target="#changeProfile">Change Profile Photo</button>

            <button class="btn btn-default btn-sm float-right mr-1" style="border-radius: 5px;" data-toggle="modal" data-target="#editProfile">Edit Profile</button>
        </div>
    </div>
    <br><br>
    <br><br>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <i class="fa fa-picture-o fa-2x float-left font-icon" style="cursor:pointer;" onclick="loadFileForProfile()"></i>
                        ...
                        <span id="fileSelectedDisplay_ForProfile">
                            ...
                            <label class="ml-1 mt-1 font-icon" style="cursor:pointer;" onclick="discardFileForProfile()">&times;</label>
                        </span>

                        <input type="button" id="profileImage_SubmitBtn" value="Update" class="btn btn-primary float-right" onclick="submitProfilePicture()">
