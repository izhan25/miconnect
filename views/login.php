    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="login" ng-submit="signin(login)" ng-validate="signinValidate">
...
<div class="modal fade" id="signupForm" tabindex="-1" role="dialog" aria-labelledby="signup" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form ng-submit="register(registration)" ng-validate="registerValidate" id="signupForm" method="POST" name="registration">
                    <div class="form-group">
                        <label>User Name</label>
